        ...
        if (res.status === 200) {
          ...
          httpClient
            ...
            .then(() => {
              ...
              // Set the patient as being in a meeting as well
                ...
                httpClient
                  ...
                  .then((res) => {
                    if (res.data.curmeet) {
                      ...
                      // If doctor didn't join, clean up
                      httpClient.put("/delete_meet", {
                        email: selectEmail,
                        usertype: "doctor",
                      });

                      // Also clean up patient status
                      httpClient.put("/delete_meet", {
                        email: localStorage.getItem("email"),
                        usertype: "patient",
                      });
                      ...
                      setConnecting(false);
                      setMessage(
                        "Doctor didn't join the meeting. Please try again."
                      );
                    }
                  });
              }, 20000);
          ...
          setConnecting(false);
          setMessage(res.data.message || "Doctor is already in a meeting.");
        }
      });
  };
